...
describe('AlarmComponent', () => {
  ...
  //     expect(component.zones).not.toContain(
  //       jasmine.objectContaining({ subtype: 'MOTION_SENSOR' })
  //     ))
  //   it('should retain contact sensors', () =>
  //     expect(component.zones).toContain(
  //       jasmine.objectContaining({ subtype: 'V_CONTACT' })
  //     ))
  // })
  xdescribe('troubledZones', () => {
    it('should retain the troubled zones', () =>
      expect(component.troubledZones).toContain(
        jasmine.objectContaining({ subtype: 'SHOCK_CONTACT' })
      ))
    it('should filter out untroubled zones', () =>
      expect(component.troubledZones).not.toContain(
        jasmine.objectContaining({ subtype: 'V_CONTACT' })
      ))
  })
